...
namespace PlansUniversal
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
		{
			...
			//{
			//	//conn.Insert(task);
			//	//MainTask gettedTask = conn.ExecuteScalar<MainTask>("SELECT * FROM MainTask");
			//	//Console.WriteLine("task = " + gettedTask.Title);
			//	//var q = conn.Query<MainTask>("SELECT * FROM MainTask");
